...
def main(args):
    ...
    elif model_name == "llama-3.2-3b-legal":
        model_path = "ahmadsakor/Llama3.2-3B-Instruct-Legal-Summarization"
    ...
    for dataset_idx, item in data_samples:
        ...
        try:
            ...
            print(f"Processing sample {current_sample} (dataset index {dataset_idx})")
